...
global helber
helber="""
--- README of exp19-stringtie2ballgown-fast ---
 Title:
  Batch Processing for StringTie (Compare)

 Usage:
  python exp19-s2b-fast -t <TRIBE> -g <GROUP,GROUP,GROUP...>
...
class stititobago(librun.workflow):
    def pesonai(self):
        ...
        self.filasi = "exp19-stringtie2ballgown-fast"
        self.libadi = {
        ...
        self.prelogi = self.libadi.get("result/log")+"/exp19-s2b-fast-"
