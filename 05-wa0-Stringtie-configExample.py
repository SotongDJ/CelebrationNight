...
data/05-wa-Stringtie/testing/speciesAnnotationA-trimQ30/T1r1.gtf
data/05-wa-Stringtie/testing/speciesAnnotationA-trimQ30-merged.gtf
data/05-wa-Stringtie/testing/speciesAnnotationA-trimQ30/T1r1-expression.tsv
data/05-wa-ballgown/testing/speciesAnnotationA-trimQ30-T1r1/
data/05-wa-ballgown/testing/speciesAnnotationA-trimQ30-T1r1/T1r1-expression.gtf
testing => testing
["Control","T1","T2","T3","T4","T5"] => ["Control","T1","T2","T3","T4","T5"]
["r1","r2","r3"] => ["r1","r2","r3"]
SpeA, speciesAnnotationA => SpeA, speciesAnnotationA
SpeB, speciesAnnotationB => SpeB, speciesAnnotationB
SpeC, speciesAnnotationC => SpeC, speciesAnnotationC
"""
...
expRep.queryDict = {
    ...
    # above: data/05-wa-Stringtie/testing/speciesAnnotationA-trimQ30/T1r1.gtf
    ...
    # above: data/05-wa-ballgown/testing/speciesAnnotationA-trimQ30-T1r1/T1r1-expression.gtf
    "testing" : False,
}
