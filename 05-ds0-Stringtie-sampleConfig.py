...
data/05-ds-Stringtie/testing/speciesAnnotationA-trimQ30/T1r1-expression.tsv
data/05-ds-ballgown/testing/speciesAnnotationA-trimQ30-T1r1/
data/05-ds-ballgown/testing/speciesAnnotationA-trimQ30-T1r1/T1r1-expression.gtf
...
expRep.queryDict = {
    ...
    # above: data/05-ds-Stringtie/testing/speciesAnnotationA-trimQ30/T1r1-expression.tsv
    "[dsStringtie]ballgownFolder" : "data/05-ds-ballgown/testing/{annotateCondition}-{trimCondition}-{group}{replication}/",
    # above: data/05-ds-ballgown/testing/speciesAnnotationA-trimQ30-T1r1/
    ...
    # above: data/05-ds-ballgown/testing/speciesAnnotationA-trimQ30-T1r1/T1r1-expression.gtf
    ...
    # above: data/05-ds-ballgown/testing/speciesAnnotationA-trimQ30-A1/A1-expression.gtf
    ...
    # above: data/05-ds-Stringtie/testing/speciesAnnotationA-trimQ30-merged.gtf
    "testing" : False,
}
